...
const MemberShape = ({ classname, width = "270px", height = "117px" }) => {
  return (
    <div className={`${classname} flex items-center justify-center`}>
      <div className="w-full flex items-center justify-center absolute gap-5">
        <div className="icon p-0 flex items-center justify-center bg-white rounded-sm transition-all duration-700"></div>
        <div className="icon p-0 flex items-center justify-center bg-white rounded-sm transition-all duration-700"></div>
        <div className="icon p-0 flex items-center justify-center bg-white rounded-sm transition-all duration-700"></div>
        <div className="icon p-0 flex items-center justify-center bg-white rounded-sm transition-all duration-700"></div>
        <div className="icon p-0 flex items-center justify-center bg-white rounded-sm transition-all duration-700"></div>
